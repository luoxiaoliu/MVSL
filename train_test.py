...
import trainers.BiomedCoOp.biomedcoop_biomedclip_moe_5_0_15_0_16 as biomedcoop_biomedclip
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", type=str, default="/home/zrway/willow/BiomedCoOp-main/data", help="path to dataset")
    parser.add_argument("--output-dir", type=str, default="/home/zrway/willow/BiomedCoOp-main/output/btmri/shots_1/BiomedCoOp_BiomedCLIP/nctx4_cscFalse_ctpend", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--config-file", type=str, default="/home/zrway/willow/BiomedCoOp-main/configs/trainers/BiomedCoOp/few_shot/btmri.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
        default="/home/zrway/willow/BiomedCoOp-main/configs/datasets/btmri.yaml",
        help="path to config file for dataset setup",
    )
    parser.add_argument("--trainer", type=str, default="BiomedCoOp_BiomedCLIP", help="name of trainer")
    parser.add_argument("--backbone", type=str, default="", help="name of CNN backbone")
    parser.add_argument("--head", type=str, default="", help="name of head")
    parser.add_argument("--eval-only", default=True, help="evaluation only")
    parser.add_argument(
        "--model-dir",
        type=str,
        default="/home/zrway/willow/BiomedCoOp-main/output/btmri/shots_1/BiomedCoOp_BiomedCLIP/nctx4_cscFalse_ctpend/seed1",
        help="load model from this directory for eval-only mode",
    )
    parser.add_argument(
        "--load-epoch", type=int,default=100, help="load model weights at this epoch for evaluation"
    )
    parser.add_argument(
