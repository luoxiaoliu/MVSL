...
import trainers.BiomedMVSL.biomedmvsl_biomedclip as biomedmvsl_biomedclip
...
def extend_cfg(cfg):
    ...
    # Default config for BiomedMVSL
    cfg.TRAINER.BIOMEDMVSL = CN()
    cfg.TRAINER.BIOMEDMVSL.CTX_INIT = "a photo of a"  # initialization words
    cfg.TRAINER.BIOMEDMVSL.CSC = False  # class-specific context
    cfg.TRAINER.BIOMEDMVSL.CLASS_TOKEN_POSITION = "end"  # 'middle' or 'end' or 'front'
    cfg.TRAINER.BIOMEDMVSL.N_CTX = 4  # number of context vectors
    cfg.TRAINER.BIOMEDMVSL.PREC = "fp32"  # fp16, fp32, amp
    cfg.TRAINER.BIOMEDMVSL.SCCM_LAMBDA = 1.0
    cfg.TRAINER.BIOMEDMVSL.KDSP_LAMBDA = 1.0
    # cfg.TRAINER.BIOMEDMVSL.TAU = 1.5
    cfg.TRAINER.BIOMEDMVSL.N_PROMPTS = 50
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", type=str, default="/home/zrway/willow/BiomedMVSL/data", help="path to dataset")
    parser.add_argument("--output-dir", type=str, default="/home/zrway/willow/BiomedMVSL/output_debug/dermamnist/shots_16/BiomedMVSL_BiomedCLIP/nctx4_cscFalse_ctpend", help="output directory")
    # parser.add_argument("--output-dir", type=str, default="/home/zrway/willow/BiomedCoOp-main/output/btmri/shots_16/BiomedCoOp_BiomedCLIP/nctx4_cscFalse_ctpend", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--config-file", type=str, default="/home/zrway/willow/BiomedMVSL/configs/trainers/BiomedMVSL/few_shot/dermamnist.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
        default="/home/zrway/willow/BiomedMVSL/configs/datasets/dermamnist.yaml",
        help="path to config file for dataset setup",
    )
    parser.add_argument("--trainer", type=str, default="BiomedMVSL_BiomedCLIP", help="name of trainer")
