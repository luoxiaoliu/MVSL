...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="/home/zrway/willow/BiomedCoOp-main/output/output_moe_5_0_15_0_16/base2new/train_base/busi/seed2", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--config-file", type=str, default="/home/zrway/willow/BiomedCoOp-main/configs/trainers/BiomedCoOp/base_to_novel/busi.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
        default="/home/zrway/willow/BiomedCoOp-main/configs/datasets/busi.yaml",
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="/home/zrway/willow/BiomedCoOp-main/output/output_moe_5_0_15_0_16/base2new/train_base/busi/seed2",
    ...
    # )
    parser.add_argument(
        "--no-train", default=True, help="do not call trainer.train()"
    )
    parser.add_argument(
        "opts",
        default=None,
